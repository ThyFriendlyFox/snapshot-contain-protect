...
- **Shipping:** v0.1.0. Items 2, 7 and 9 are done. Item 1 needs branch protection, which is a repository setting the human applies. Item 3, the volume-scoped workset model, is next.
